...
N 660 -430 660 -300 {lab=#net1}
N 900 -430 900 -300 {lab=#net2}
N 700 -640 720 -640 {lab=outp}
N 720 -640 720 -460 {lab=outp}
N 700 -460 720 -460 {lab=outp}
N 840 -460 860 -460 {lab=voutn}
N 840 -640 840 -460 {lab=voutn}
N 840 -640 860 -640 {lab=voutn}
...
N 660 -610 660 -490 {lab=voutn}
N 900 -610 900 -490 {lab=outp}
N 380 -550 660 -550 {lab=voutn}
N 450 -610 450 -550 {lab=voutn}
...
N 750 -570 810 -510 {lab=voutn}
N 810 -510 840 -510 {lab=voutn}
N 660 -570 750 -570 {lab=voutn}
...
C {devices/iopin.sym} 140 -750 2 0 {name=p4 lab=vdd}
