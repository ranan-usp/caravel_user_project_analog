...
N 310 -480 370 -480 {lab=ctlp[5:0]}
N 340 -210 370 -210 {lab=vinn}
N 310 -160 370 -160 {lab=ctln[5:0]}
...
C {devices/lab_wire.sym} 370 -480 0 0 {name=l11 sig_type=std_logic lab=ctlp[5:0]
}
